...
def main():
    ...
    message1 = myfont.render('This is my message', 1, (255, 150, 255))
    message2 = myfont.render('This is PyGame', 0, (255, 150, 255))
    ...
    while 1:
        ...
        line(Surface, (0,0,255), (30, 90), (150, 120), 7)
        
        for x in range(10, 400, 10): # 세로줄
            line(Surface, 'white', (x, 0), (x, 400))
        
        for y in range(10, 400, 10): # 가로줄
        ...
        ellipse(Surface, 'yellow', (280, 300, 100, 50), 10)
